/**
 * ContactForm page of the pencilblue theme
 *
...
ContactForm.prototype.render = function(cb) {
    var self = this;
                ...
                self.getSideNavigation(data.content, function(sideNavTemplate, sideNavItems) {
                    self.ts.load(sideNavTemplate, function(err, sideNavTemplate) {
                        ...
                        self.getTemplate(data.content, function(err, template) {
                            ...
                            self.ts.load('contactform', function(err, result) {
                                if (util.isError(err)) {
                                    throw err;
                                }
...
ContactForm.prototype.getTemplate = function(content, cb) {
...
ContactForm.prototype.gatherData = function(cb) {
    var self  = this;
    var tasks = {
...
ContactForm.prototype.loadContent = function(articleCallback) {
...
ContactForm.prototype.renderContent = function(content, contentSettings, themeSettings, index, cb) {
    var self = this;
...
ContactForm.prototype.renderComments = function(content, ts, cb) {
    var self           = this;
...
ContactForm.prototype.renderComment = function(comment, cb) {
...
ContactForm.prototype.getContentSpecificPageName = function(content, cb) {
...
ContactForm.prototype.getNavigation = function(cb) {
    var options = {
...
ContactForm.prototype.getSideNavigation = function(articles, cb) {
    var self = this;
...
ContactForm.getRoutes = function(cb) {
    var routes = [
        {
            method: 'get',
            path: '/page/54a7f681e22ec018176ed7d7/',
            auth_required: false,
