/**
 * Blog2 page of the pencilblue theme
 *
...
Blog2.prototype.getTemplate = function(content, cb) {
...
Blog2.prototype.renderComments = function(content, ts, cb) {
    var self           = this;
...
Blog2.prototype.renderComment = function(comment, cb) {
...
Blog2.prototype.getContentSpecificPageName = function(content, cb) {
...
Blog2.prototype.getSideNavigation = function(articles, cb) {
    var self = this;
