/**
 * SingleArticle page of the pencilblue theme
 *
...
//inheritance
util.inherits(SingleArticle, pb.BaseController);

SingleArticle.prototype.render = function(cb) {
    var self = this;
                ...
                self.getSideNavigation(data.content, function(sideNavTemplate, sideNavItems) {
                    self.ts.load(sideNavTemplate, function(err, sideNavTemplate) {
                        ...
                        self.getTemplate(data.content, function(err, template) {
                            ...
                            self.ts.load('single', function(err, result) {
                                if (util.isError(err)) {
                                    throw err;
                                }
...
SingleArticle.prototype.getTemplate = function(content, cb) {
...
SingleArticle.prototype.gatherData = function(cb) {
    var self  = this;
    var tasks = {
...
SingleArticle.prototype.loadContent = function(articleCallback) {
...
SingleArticle.prototype.renderContent = function(content, contentSettings, themeSettings, index, cb) {
    var self = this;
...
SingleArticle.prototype.renderComments = function(content, ts, cb) {
    var self           = this;
...
SingleArticle.prototype.renderComment = function(comment, cb) {
...
SingleArticle.prototype.getContentSpecificPageName = function(content, cb) {
...
SingleArticle.prototype.getNavigation = function(cb) {
    var options = {
...
SingleArticle.prototype.getSideNavigation = function(articles, cb) {
    var self = this;

    pb.plugins.getSetting('show_side_navigation', 'contact', function(err, showSideNavigation) {
...
*/
SingleArticle.getRoutes = function(cb) {
    var routes = [
        {
            method: 'get',
            path: '/article/*',
