/**
 * Works page of the pencilblue theme
 *
...
//inheritance
util.inherits(Works, pb.BaseController);

Works.prototype.render = function(cb) {
    var self = this;
                ...
                self.getSideNavigation(data.content, function(sideNavTemplate, sideNavItems) {
                    self.ts.load(sideNavTemplate, function(err, sideNavTemplate) {
                        ...
                        self.getTemplate(data.content, function(err, template) {
                            ...
                            self.ts.load('works', function(err, result) {
                                if (util.isError(err)) {
                                    throw err;
                                }
...
Works.prototype.getTemplate = function(content, cb) {
...
Works.prototype.gatherData = function(cb) {
    var self  = this;
    var tasks = {
...
Works.prototype.loadContent = function(articleCallback) {
...
Works.prototype.renderContent = function(content, contentSettings, themeSettings, index, cb) {
    var self = this;
...
Works.prototype.renderComments = function(content, ts, cb) {
    var self           = this;
...
Works.prototype.renderComment = function(comment, cb) {
...
Works.prototype.getContentSpecificPageName = function(content, cb) {
...
Works.prototype.getNavigation = function(cb) {
    var options = {
...
Works.prototype.getSideNavigation = function(articles, cb) {
    var self = this;
...
Works.getRoutes = function(cb) {
    var routes = [
        {
            method: 'get',
            path: '/page/54ac4057c877dd080003c7ca/',
            auth_required: false,
